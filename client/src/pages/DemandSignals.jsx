...
export default function DemandSignals() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 animate-slide-up stagger-1">
        <div>
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-text flex items-center gap-3 flex-wrap">
            ...
            <AskAIButton
              variant="chip"
              label="Ask Copilot Impact"
              prompt="Evaluate our current multi-signal demand heatmap (Google Search Trends, Weather Factor, Local Events, Social Sentiment) and summarize which product categories should raise or lower base pricing."
            />
          </h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 animate-slide-up stagger-2">
        <div className="glass-card glass-card-hover p-5">
          ...
          <div className="flex items-center gap-1.5 mt-1.5">
            ...
            <span className="text-[11px] text-text-muted">vs last week</span>
          </div>
        </div>
        ...
        <div className="glass-card glass-card-hover p-5">
          ...
          <p className="text-xs text-text-muted mt-1.5">Across catalog</p>
        </div>
        ...
        <div className="glass-card glass-card-hover p-5">
          ...
          <p className="text-xs text-text-muted mt-1.5">+312 from yesterday</p>
        </div>
        ...
        <div className="glass-card glass-card-hover p-5">
          ...
          <p className="text-xs text-text-muted mt-1.5">Score &gt; 70 · Hot items</p>
        </div>
      </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-3 relative z-10">
                  ...
                  <span className="text-[10px] text-text-muted relative z-10">{badge.trend}</span>
                </div>
                <p className="text-sm font-semibold text-text truncate relative z-10" title={item.fullName}>
                  {item.fullName}
                </p>
                <p className="text-[10px] text-text-muted mb-3 relative z-10">{item.category}</p>
                <div className="flex items-end justify-between relative z-10">
                  <p className="text-2xl font-bold tracking-tight text-text">{item.demand}</p>
        ...
        <div className="flex items-center justify-between pt-4 mt-4 border-t border-border">
          ...
          {heatmapData.length > 6 && (
            <button
              ...
              className="text-xs font-semibold flex items-center gap-1.5 transition-colors text-primary-light hover:text-primary cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-[11px] font-semibold uppercase tracking-wider text-text-muted">Signal Dimension Breakdown</h3>
                  {selectedBadge && (
                    <span
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-[11px] font-semibold uppercase tracking-wider text-text-muted mb-4">Score Trend · 14 Days</h3>
                ...
                <div>
                  <h3 className="text-[11px] font-semibold uppercase tracking-wider text-text-muted mb-4">Signal Sources</h3>
        ...
        <div className="glass-card p-6 animate-slide-up stagger-5">
          ...
          <div className="mt-6 pt-5 border-t border-border">
            <h3 className="text-[11px] font-semibold uppercase tracking-wider text-text-muted mb-3">Composite Formula</h3>
      ...
      {/* ── Footer note ── */}
      <div className="text-center text-[11px] text-text-muted pt-2 pb-6 animate-fade-in">
