...
const ExplainabilityPanel = ({ xaiData, recommendations = [] }) => {
    ...
    const { currentFactors, currentSimulations } = useMemo(() => {
        let factors = xaiData?.factors || [];
        let simulations = xaiData?.simulations || { basePrice: 0, scenarios: [] };
        ...
        return { currentFactors: factors, currentSimulations: simulations };
